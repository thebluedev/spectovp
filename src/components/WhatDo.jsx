...
export default function WhatDo() {
  return (
    <div className="mt-[12.5vh] text-4xl text-left xl:text-5xl font-bol overflow-hidden">
      ...
      <h2 className="pl-[2.5rem] lg:pl-20 text-2xl mt-5 text-left xl:text-4xl pt-5 font-normal block  w-[24rem] md:w-[50rem] lg:w-[75rem] text-wrap lg:mb-20 mb-[15rem] ">
